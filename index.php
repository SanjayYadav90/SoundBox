                     ...
                     <div class="app-grids">
                        <div class="app">
                           <div class="col-md-5 app-left mpl">
                              <h3>RockStar mobile app on your smartphone!</h3>
            ...
            <div id="page-wrapper">
               <div class="inner-content">
                  <div class="music-left">
                              ...
                              <ul class="rslides callbacks callbacks1" id="slider4">
                                 <li>
                                    <div class="banner-img">
                                       <img src="images/banner/banner1.jpg" class="img-responsive" alt="">
                                    </div>
                                 ...
                                 <li>
                                    <div class="banner-img">
                                       <img src="images/banner/banner2.jpg" class="img-responsive" alt="">
                                    </div>
                                    <div class="banner-info">
                                       <a class="trend" href="single.php">TRENDING</a>
                                 ...
                                 <li>
                                    <div class="banner-img">
                                       <img src="images/banner/banner3.jpg" class="img-responsive" alt="">
                                    </div>
                                    <div class="banner-info">
                                       <a class="trend" href="single.php">TRENDING</a>
                                       <h3>Let Your Home</h3>
                     ...
                     <div class="albums">
                        ...
                        <div class="col-md-3 content-grid">
                           <a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="images/home/v1.jpg" title="allbum-name"></a>
                        ...
                        <div class="col-md-3 content-grid">
                           <a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="images/home/v2.jpg" title="allbum-name"></a>
                           <a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
                        </div>
                        <div class="col-md-3 content-grid">
                           <a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="images/home/v3.jpg" title="allbum-name"></a>
                           <a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
                        </div>
                        ...
                        <div class="col-md-3 content-grid">
                           <a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="images/home/v8.jpg" title="allbum-name"></a>
                           <a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
                        </div>
                        <div id="small-dialog" class="mfp-hide">
                           <iframe src="https://player.vimeo.com/video/12985622"></iframe>
                        ...
                        <div class="col-md-3 content-grid">
                           <a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="images/home/v6.jpg" title="allbum-name"></a>
                           <a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
                        </div>
                        <div class="col-md-3 content-grid">
                           <a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="images/home/v5.jpg" title="allbum-name"></a>
                           <a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
                        </div>
                        <div class="col-md-3 content-grid last-grid">
                           <a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="images/home/v8.jpg" title="allbum-name"></a>
                     ...
                     <div class="albums second">
                        ...
                        <div class="col-md-3 content-grid">
                           <a href="audio-browse.php"><img src="images/home/v11.jpg" title="allbum-name"></a>
                           <div class="inner-info">
                              <a href="audio-browse.php">
                                 <h5>Pop demo</h5>
                              </a>
                           </div>
                        </div>
                        <div class="col-md-3 content-grid">
                           <a href="single.php"><img src="images/home/v22.jpg" title="allbum-name"></a>
                           <div class="inner-info">
                              <a href="single.php">
                                 <h5>Pop</h5>
                              </a>
                        ...
                        <div class="col-md-3 content-grid">
                           <a href="single.php"><img src="images/home/v33.jpg" title="allbum-name"></a>
                           <div class="inner-info">
                              <a href="single.php">
                                 <h5>Pop</h5>
                              </a>
                        ...
                        <div class="col-md-3 content-grid last-grid">
                           <a href="single.php"><img src="images/home/v44.jpg" title="allbum-name"></a>
                           <div class="inner-info">
                              <a href="single.php">
                                 <h5>Pop</h5>
                              </a>
                        ...
                        <div class="col-md-3 content-grid">
                           <a href="single.php"><img src="images/home/v55.jpg" title="allbum-name"></a>
                           <div class="inner-info">
                              <a href="single.php">
                                 <h5>Pop</h5>
                              </a>
                        ...
                        <div class="col-md-3 content-grid">
                           <a href="single.php"><img src="images/home/v66.jpg" title="allbum-name"></a>
                           <div class="inner-info">
                              <a href="single.php">
                                 <h5>Pop</h5>
                              </a>
                        ...
                        <div class="col-md-3 content-grid">
                           <a href="single.php"><img src="images/home/v11.jpg" title="allbum-name"></a>
                           <div class="inner-info">
                              <a href="single.php">
                                 <h5>Pop</h5>
                              </a>
                  ...
                  <div class="music-right">
                     ...
                     <script type="text/javascript">
                        ...
                        $(document).ready(function(){
                           ...
                           new jPlayerPlaylist({
                              ...
                              {
                                 title:"1. Pyar ki 1 khani",
                                 artist:"",
                                 mp4: "video/02.Aao_sunau_pyar ki_ek.MP4",
                                 ogv: "video/02.Aao_sunau_pyar ki_ek.MP4",
                                 webmv: "video/02.Aao_sunau_pyar ki_ek.MP4",
                                 poster:"video/play1.png"
                              },
                              {
                                 title:"2. Dhanno Dhanno re...",
                                 artist:"",
                                 mp4: "video/04.Dhanno-Housefull.MP4",
                                 ogv: "video/04.Dhanno-Housefull.MP4",
                                 webmv: "video/04.Dhanno-Housefull.MP4",
                                 poster:"video/play2.png"
                              },
                              {
                                 title:"3. Blue  Eyes",
                                 artist:"",
                                 mp4: "video/03.Blue_Eyes.mp4",
                                 ogv: "video/03.Blue_Eyes.mp4",
                                 webmv: "video/03.Blue_Eyes.mp4",
                                 poster:"video/play1.png"
                              },
                              {
                                 title:"4. Dil Tu Hi Bataa",
                                 artist:"",
                                 mp4: "video/06.Dil-Tu-Hi-Bataa.mp4",
                                 ogv: "video/06.Dil-Tu-Hi-Bataa.mp4",
                                 webmv: "video/06.Dil-Tu-Hi-Bataa.mp4",
                                 poster:"video/play4.png"
                              },
                              {
                                 title:"5. Aaj Blue Pani",
                                 artist:"",
                                 mp4: "video/08_ajj_blue __pani.mp4",
                                 ogv: "video/Pharrell-Williams.ogv",
                                 webmv: "video/08_ajj_blue __pani.mp4",
                     ...
                     <!--/app_store-->
                     <div class="apps">
                        <h3 class="hd-tittle">Top most linten Song</h3>
                        <div class="banner-button">
                           <a href="#"><img src="images/v11.jpg" alt=""></a>
                        </div>
                        <div class="banner-button green-button">
                           <a href="#"><img src="images/v1.jpg" alt=""></a>
                        </div>
                        <div class="clearfix"></div>
                     </div>
                     <!--//app_store-->
                     ...
                     <div class="price-section">
                        <div class="pricing-inner">
                           <h3 class="hd-tittle">Permote your Albums</h3>
                           <div class="pricing">
                              <div class="price-top">
                                 <h3><span>Balma Bawali</span></h3>
                                 <h4>Khesari Lal Yadav</h4>
                              </div>
                              <div class="price-bottom">
                                 <ul>
                                    <li>
                                       <a class="icon" href="#"><i class="glyphicon glyphicon-ok"></i></a><a class="text" href="#">Download unlimited songs</a>
                                       <div class="clearfix"></div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                       <a class="icon" href="#"><i class="glyphicon glyphicon-ok"></i></a><a class="text" href="#">No ads unlimited Devices</a>
                                       <div class="clearfix"></div>
                                    </li>
                                    <li>
                                       <a class="icon" href="#"><i class="glyphicon glyphicon-ok"></i></a><a class="text" href="#">Stream songs in High Definition</a>
                                 ...
                                 <a href="single.php" class="price">Play Now</a>
                              </div>
                           </div>
                           <div class="pricing two">
                              <div class="price-top">
                                 <h3><span>Bigdal Chaurui</span></h3>
